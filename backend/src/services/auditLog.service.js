...
const AUDIT_EVENT_TYPES = Object.freeze({
  ...
  USER_IDENTITY_CORRECTED: 'USER_IDENTITY_CORRECTED',
  ...
  USER_INVITATION_DELIVERY_FAILED: 'USER_INVITATION_DELIVERY_FAILED',
  USER_INVITATION_RESENT: 'USER_INVITATION_RESENT',
  USER_INVITATION_ACCEPTED: 'USER_INVITATION_ACCEPTED',
  BULK_USER_INVITATIONS_SENT: 'BULK_USER_INVITATIONS_SENT',
